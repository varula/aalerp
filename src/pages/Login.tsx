      ...
      >
        ...
        <Card className="border-border/40">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>Access your production dashboard</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* Social Logins */}
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" onClick={handleGoogle} className="h-10 text-xs">
              ...
              <Button variant="outline" onClick={handleApple} className="h-10 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="you@armanagroup.com"
                    value={email}
