...
const fadeUp = {
  ...
  visible: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.45, ease: appleEase } },
} as const;

const fadeIn = {
  hidden: { opacity: 0, y: 16 },
  visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: appleEase } },
} as const;
...
export default function Dashboard() {
  ...
  return (
    ...
    >
      ...
      {/* Quick stats */}
      <motion.div className="grid grid-cols-2 sm:grid-cols-4 gap-4" variants={stagger}>
        <motion.div variants={fadeUp}>
      ...
      <motion.div variants={fadeUp}>
        <Card>
          ...
          <CardContent>
            <motion.div
              className="grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-16 gap-2"
              variants={stagger}
            >
