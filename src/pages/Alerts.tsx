      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-semibold flex items-center gap-2">
            <Bell className="h-4 w-4" /> Live Andon Status
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-wrap gap-1.5">
            {allLines
              ...
              .map(line => (
                <div
                  key={line.id}
                  className={`h-8 w-12 rounded flex items-center justify-center text-[10px] font-mono font-bold text-white ${sevDot(line.status)}`}
            ...
            <Table>
              ...
              <TableBody>
                {filteredAlerts.map(alert => {
                  ...
                  return (
                    <TableRow key={alert.id} className={ack ? "opacity-50" : ""}>
                      <TableCell>
                      ...
                      <TableCell className="font-mono text-sm">{line?.name || "-"}</TableCell>
