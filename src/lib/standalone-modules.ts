...
export const standaloneCrudModules: Record<string, ModuleDef> = {
  ...
  "cut-to-pack": {
    ...
    fields: [
      ...
      { key: "cutQty", label: "Cut Qty", type: "number", required: true },
      { key: "inputToSewing", label: "Input to Sewing", type: "number" },
      { key: "sewingOutput", label: "Sewing Output", type: "number" },
      { key: "finishingInput", label: "Finishing Input", type: "number" },
      { key: "finishingOutput", label: "Finishing Output", type: "number" },
