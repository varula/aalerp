...
export const standaloneCrudModules: Record<string, ModuleDef> = {
  ...
  "inspections": {
    ...
    fields: [
      ...
      { key: "inspectedQty", label: "Inspected Qty", type: "number", validation: { min: 0 } },
      { key: "passQty", label: "Pass Qty", type: "number", validation: { min: 0 } },
      { key: "failQty", label: "Fail Qty", type: "number", validation: { min: 0 } },
      { key: "defectRate", label: "Defect Rate %", type: "number", validation: { min: 0, max: 100 } },
  ...
  "skills": {
    ...
    fields: [
      ...
      { key: "efficiency", label: "Efficiency %", type: "number", validation: { min: 0, max: 100 } },
      { key: "smv", label: "Operation SMV", type: "number", validation: { min: 0 } },
  ...
  "attendance": {
    ...
    fields: [
      ...
      { key: "totalStaff", label: "Total Staff", type: "number", required: true, validation: { min: 1 } },
      { key: "present", label: "Present", type: "number", required: true, validation: { min: 0 } },
      { key: "absent", label: "Absent", type: "number", validation: { min: 0 } },
      { key: "late", label: "Late", type: "number", validation: { min: 0 } },
      { key: "leave", label: "On Leave", type: "number", validation: { min: 0 } },
      { key: "overtime", label: "Overtime (hrs)", type: "number", validation: { min: 0 } },
      { key: "absenteeRate", label: "Absentee Rate %", type: "number", validation: { min: 0, max: 100 } },
      remarksField,
    ],
  },
  ...
  "ai-defects": {
    ...
    fields: [
      ...
      { key: "totalScanned", label: "Total Scanned", type: "number", validation: { min: 0 } },
      { key: "defectsDetected", label: "Defects Detected", type: "number", validation: { min: 0 } },
      { key: "falsePositives", label: "False Positives", type: "number", validation: { min: 0 } },
      { key: "defectTypes", label: "Defect Types", type: "textarea" },
      { key: "accuracy", label: "Detection Accuracy %", type: "number", validation: { min: 0, max: 100 } },
